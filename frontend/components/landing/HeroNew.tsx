    ...
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 relative z-10 w-full pt-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-blue-600 dark:text-blue-400 font-semibold mb-6 animate-slide-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="mb-8 animate-slide-up" style={{ animationDelay: '0.3s' }}>
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-3">
                Search medicines, listings, news, and more... (Login required to view details)
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up" style={{ animationDelay: '0.5s' }}>
            <Link
              ...
              className="px-8 py-4 bg-blue-600 dark:bg-blue-500 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600
                       transition-all hover:scale-105 focus:ring-2 focus:ring-blue-500 focus:outline-none flex items-center gap-2 text-lg font-semibold shadow-lg shadow-blue-500/30"
            >
              Start Trading
            ...
            <Link
              ...
              className="px-8 py-4 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 rounded-lg
                       hover:bg-gray-50 dark:hover:bg-gray-800 transition-all hover:scale-105 text-lg font-semibold"
            >
              Learn More
            </Link>
          </div>
